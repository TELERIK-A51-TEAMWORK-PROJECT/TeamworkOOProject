...
class CreatePackageCommand:
    ...
    def execute(self):
        package_id,package_name,package_kg,email,end_location = self._params
        ...
        self._app_data.create_package(package_id, package_name, package_kg, email, end_location)
        ...
        result += f'Info of package: Name: {package_name} | Kilograms: {package_kg} | Customer Email: ({customer.email}) Delivery location: ({end_location})\n'
